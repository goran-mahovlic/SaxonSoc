...
- Ulx4m 12f, 45f or 85f ECP5 board with 32Mb or 64Mb of SDRAM
- USB micro cable
- Micro SD card
...
source SaxonSoc/bsp/radiona/ulx4m/smp/source.sh
...
If you include the FPU in the bitstream, you must also include it in the Linux build. This is done by manually editing the following lines in $SAXON_ROOT/buildroot-spinal-saxon/configs/saxon_ulx4m_defconfig:
...
source SaxonSoc/bsp/radiona/ulx4m/smp/source.sh
cd $SAXON_ROOT
fujprog -j FLASH SaxonSoc/hardware/synthesis/radiona/ulx4m/smp/bin/toplevel.bit
...
You can use a LAN8720 Microchip RMII board connected directly to the Ulx4m at the corner next to the sd card reader in the position of gp/gn pins 9-13.

Make sure that you do not connecting to the other corner of the Ulx4m board which has the 5v pin, as the board is not 5v-tolerant.
...
There is a native [LCC C compiler](https://github.com/lawrie/saxonsoc-ulx4m-bin/blob/master/Smp/images/riscv32_lcc.tar.gz) available.
